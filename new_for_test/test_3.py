...
class CountdownAppContent(ft.Column):
    ...
    def set_background(self, image_path):
        """Establece la imagen de fondo de la aplicación."""
        # Se elimina la llamada a page.update() aquí.
        # La actualización se maneja en la función principal después de la navegación.
...
def main(page: ft.Page):
    ...
    def route_change(route):
        ...
        # --- Vista de la Aplicación Principal ---
            ...
            # Envuelve el contenido en un contenedor para manejar el fondo
            main_container = ft.Container(
                ...
                content=ft.Column(
                    ...
                    alignment=ft.MainAxisAlignment.CENTER, # Alinea la columna al centro del contenedor
                ),
                image=ft.DecorationImage(
                    src=app_content.background_image_path,
                    fit=ft.ImageFit.COVER,
                ) if app_content.background_image_path else None,
            )
            ...
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.AppBar(
                            title=ft.Text("Reproductor y Temporizador"),
        ...
        # --- Vista de Selección de Fondo ---
            ...
            # La actualización de la página y la navegación se manejan secuencialmente aquí.
            ...
            # Columnas de botones para cada imagen
            image_buttons = [
                ft.Container(
                    ...
                    alignment=ft.alignment.center,
                    on_click=lambda e, path=image: page.run_task(select_background_and_go_app, e, path)
                )
                for image in images
            ]
